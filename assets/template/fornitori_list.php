<div class="container" menu_link="fornitori_list" >
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card-box">
				<table id="tab_fornitori" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Azioni</th>
					...
					<tbody>
						<?php
						foreach ($this->record_fornitori as $record) {
							?>
							<tr id_fornitore="<?=$record->id_fornitore;?>" >
