<div class="container" menu_link="fatture_new_<?=$this->fattura_type;?>" >
	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="form-group">
				...
				<div class="col-md-10" required>
					<input type="text" id="data" name="data" placeholder="" data-mask="99/99/9999" class="form-control date" value="<?=($this->fattura_type==1)?date('d/m/Y'):'';?>" data-parsley-required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="form-group">
						...
						<div class="col-md-10" >
							<input type="checkbox" id="pagata" name="pagata" class="form-control" value="1" >
						</div>
					</div>
				</div>
			</div>
