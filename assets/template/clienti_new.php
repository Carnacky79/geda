<div class="container" menu_link="clienti_new" >
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<div class="form-group">
				...
				<div class="col-md-10" required>
					<input type="number" id="p_iva" name="p_iva" class="form-control" value="" data-parsley-maxlength="11" data-parsley-required>
				</div>
			</div>
			<div class="form-group">
