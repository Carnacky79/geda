<div class="container" menu_link="utenti_list" >
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card-box">
				<table id="tab_utenti" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Azioni</th>
							<th>Nome</th>
