<div class="container" menu_link="categorie_list" >
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card-box">
				<table id="tab_categorie" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Azioni</th>
							<th>Nome</th>
					...
					<tbody>
						<?php
						foreach ($this->record_categorie as $record) {
							?>
							<tr id_categoria="<?=$record->id_categoria;?>" >
