<div class="container" menu_link="ddt_list" >
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card-box">
				<label class="col-md-10 control-label no-sides" for="tab_ddt_1" >In uscita</label>
				<table id="tab_ddt_1" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
						<tr>
...
<?php if($livello_utente===1) { ?>
	<div class="row">
		<div class="col-sm-12">
			<div class="card-box">
				<label class="col-md-10 control-label no-sides" for="tab_ddt_0" >In entrata</label>
				<table id="tab_ddt_0" class="table table-striped dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th class="action_col" >Azioni</th>
							<th>Codice</th>
