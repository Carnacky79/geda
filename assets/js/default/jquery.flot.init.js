! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ['#9842e5', '#1bb99a', "#636f82"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#28abbf']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#0094fa', '#3ec845', "#fec200", "#ff8acc"];
